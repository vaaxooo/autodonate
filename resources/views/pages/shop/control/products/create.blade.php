    ...
    <div class="nk-block-head">
        <div class="nk-block-between-md g-4">
            <div class="nk-block-head-content">
                <h2 class="nk-block-title fw-normal">{{ __('New product') }}</h2>
                <div class="nk-block-des">
                    <p>{{ __('Creating a new product') }}</p>
                </div>
            </div>
            <div class="nk-block-head-content">
    ...
    <div class="nk-block">
        <div class="card shadow">
            <div class="card-inner">
                ...
                <form action="{{ route('shop.items.create', ['shop' => $shop->id]) }}" method="POST" class="gy-3">
                    @csrf
                            ...
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="name" name="name" value=""
                                           placeholder="{{ __('Name of product') }}" required="">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="form-control-wrap">
                                    <div class="input-group">
                                        <textarea type="text" class="form-control" id="withdraw_command"
                                                  ...
                                                  placeholder="{{ __('Privilege withdrawal commands. Each command on a new line. Commands are entered without /. Leave blank if not needed') }}"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    ...
                                    <div class="button-small-container mt-2 d-block">
                                        <span class="button-small timeout_days_help" data-time="1">{{ __('Day') }}</span>
                                        <span class="button-small timeout_days_help" data-time="7">{{ __('A week') }}</span>
                                        <span class="button-small timeout_days_help" data-time="30">{{ __('1 month') }}</span>
                                        <span class="button-small timeout_days_help" data-time="90">{{ __('3 months') }}</span>
                                        <span class="button-small timeout_days_help" data-time="180">{{ __('6 months') }}</span>
                                        <span class="button-small timeout_days_help" data-time="365">{{ __('1 year') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-7 d-flex  align-center">
                            <div class="form-group">
                                <div class="user-avatar sq xl">
                                    <img src="{{ asset('assets/images/product_default_image.svg') }}" id="product_image" alt="">
                                </div>
                    ...
                    <div class="row g-3">
                        <div class="col-lg-12 offset-lg-4">
                            <div class="form-group mt-2">
                                <button type="submit" class="btn btn-lg btn-success">{{ __('Create product') }}</button>
                            </div>
                        </div>
                    </div>
                </form>
